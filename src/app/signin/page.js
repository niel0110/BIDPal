            ...
            <div className={styles.card}>
                ...
                <div className={styles.rightPanel}>
                    ...
                    <form onSubmit={handleSignIn}>
                        ...
                        <div className={styles.otherOptions} data-section="social">
                        ...
                        <div className={styles.accountSwitch} data-section="signup">
                            <p>Don't have an account? <Link href="/signup" className={styles.switchLink}>Sign Up</Link></p>
                        </div>
                    </form>
                    </div>
                </div>
